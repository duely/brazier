...
public class AspectUtil {
	...
	public static int complexity (Aspect aspect) {
		if (tier0.contains(aspect)) {
			return 0;
		} else if (tier1.contains(aspect)) {
			return 1;
		} else if (tier2.contains(aspect)) {
			return 2;
		} else if (tier3.contains(aspect)) {
			return 3;
		} else if (tier4.contains(aspect)) {
			return 4;
		} else if (tier5.contains(aspect)) {
			return 5;
		} else {
			return -1;
		}
